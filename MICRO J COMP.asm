...
INTRO DB '*************************ENZO MANAGEMENT SYSTEM*****************************$',10,13
...
CS_MALE DB 10,13,' 1    MILK        27 RS $'
                        
FS_MALE DB 10,13,' 2    BREAD        35 RS $'
                     
PANT_MALE DB 10,13,' 3    CHEESE        110 RS $'

M_SHOES DB 10,13,' 4    YOGURT        50 RS $'

CS_FEMALE DB 10,13,' 5    CEREAL        210 RS $'

PANT_FEMALE DB 10,13,' 6    RICE(5KG)        100 RS $'

F_SHOES DB 10,13,' 7    FlOUR(10KG)        120 RS $'

PANJABI DB 10,13,' 8    SUGAR(1KG)        50 RS $'

KURTI DB 10,13,' 9    COOKING OIL(1L)        250 RS $'
...
MOV A,27                        ;PRICE OF CASUAL SHIRT MALE IS MOVED TO A WHERE PRICE IS 150

JMP QUANTITY

FS_MALEB:

MOV A,35                        ;PRICE OF FORMAL SHIRT MALE IS MOVED TO A WHERE PRICE IS 140

JMP QUANTITY 

PANT_MALEB:

MOV A,110                        ;PRICE OF PANT MALE IS MOVED TO A WHERE PRICE IS 210

JMP QUANTITY 

M_SHOESB: 

MOV A,50                        ;PRICE OF MALE SHOES IS MOVED TO A WHERE PRICE IS 350

JMP QUANTITY 

CS_FEMALEB: 

MOV A,210                        ;PRICE OF CASUAL SHIRT FEMALE IS MOVED TO A WHERE PRICE IS 140

JMP QUANTITY 

PANT_FEMALEB:

MOV A,100                        ;PRICE OF PANT FEMALE IS MOVED TO A WHERE PRICE IS 220

JMP QUANTITY 

F_SHOESB:   

MOV A,120                        ;PRICE OF FEMALE SHOES IS MOVED TO A WHERE PRICE IS 310

JMP QUANTITY 

PANJABIB:   

MOV A,50                        ;PRICE OF PANJABI IS MOVED TO A WHERE PRICE IS 180

JMP QUANTITY 

KURTIB:      

MOV A,250                        ;PRICE OF KURTI IS MOVED TO A WHERE PRICE IS 225
